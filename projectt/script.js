    ...
    if (!localStorage.getItem('ekb_donations')) {
        ...
        if (!localStorage.getItem('ekb_shop')) {
            shopItems = [
                ...
                // Фоны
                { id: 's_bg1', name: '', type: 'background', value: 'texture/fonn1.jfif', price: 800 },
                { id: 's_bg2', name: '', type: 'background', value: 'texture/fonn2.jfif', price: 600 },
                { id: 's_bg3', name: '', type: 'background', value: 'texture/fonn3.jfif', price: 1200 }
            ];
